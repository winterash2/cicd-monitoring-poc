resource "google_compute_instance_template" "moon_template" {
...
# terraform import google_compute_instance_template.moon_template projects/prj-sandbox-devops-9999/global/instanceTemplates/moon-template
